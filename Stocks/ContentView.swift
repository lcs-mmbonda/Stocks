            ...
            VStack{
                    ...
                    List {
                        ...
                        Stock(shortCompany: "TSLA", companyName: "Tesla Inc.", graph: "greenwhite", price: "242.82", percentage: "↑5.43%", rectangleColor: .green).listRowSeparator(.hidden)
                            Stock(shortCompany: "WMT", companyName: "Walmart Inc", graph: "greenwhite", price: "169.78", percentage: "↑0.33%", rectangleColor: .green).listRowSeparator(.hidden)
                            Stock(shortCompany: "INTC", companyName: "Intel Corp", graph: "redwhite", price: "41.32", percentage: "↓0.93%", rectangleColor: .red).listRowSeparator(.hidden)
                            Stock(shortCompany: "AC", companyName: "Air Canada", graph: "redwhite", price: "18.09", percentage: "↓0.93%", rectangleColor: .red)
